 ...
 */
function crawford_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'crawford_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.crawford-front-page) .entry-title,
...
.colors-custom .crawford-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.crawford-front-page .panel-content .recent-posts article,
...
.colors-custom.crawford-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'crawford_custom_colors_css', $css, $hue, $saturation );
}
